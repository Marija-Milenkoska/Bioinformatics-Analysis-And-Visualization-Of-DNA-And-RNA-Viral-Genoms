...
pd.crosstab(data["Genome_type"], data["Treatment"]).plot(kind="bar", figsize=(12,6))
plt.title("Распределба на третмани според тип на геном")
plt.xlabel("Тип на геном")
plt.ylabel("Број на вируси")
plt.xticks(rotation=0)
plt.tight_layout()
plt.savefig("treatment_by_genome.png")
plt.close()